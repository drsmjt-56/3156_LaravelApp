...
text-green-700 rounded-lg text-xs font-bold
uppercase">Success</span>
                                @elseif($trx->status === 'pending')
                                    <span
                                        class="px-3 py-1 bg-orange100 text-orange-700 rounded-lg text-xs font-bold
uppercase">Pending</span>
                                @else
                                    <span
