    ...
    <div class="grid grid-cols-1 gap-8">
        ...
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
            ...
            @if($event->price == 0)
                ...
                <div class="mb-6 bg-green-50 border border-green-200 rounded-xl p-4">
                    ...
                    <p class="text-sm text-green-700 mt-1">
                        ...
                        Setelah menekan tombol di bawah,
                        sistem akan langsung menerbitkan
                        E-Ticket dan mengirimkannya ke email Anda.
                    </p>
            ...
            <form action="{{ route('checkout.store', $event->id) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full px-5 py-4 bg-white border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 outline-none transition">
                ...
                <button
                    type="submit"
                    class="w-full py-5 rounded-2xl font-black text-xl text-white transition
