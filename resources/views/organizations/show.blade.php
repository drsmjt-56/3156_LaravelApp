...
<div class="max-w-7xl mx-auto px-6 py-12">
    ...
    <div class="rounded-3xl bg-gradient-to-r from-indigo-600 to-indigo-700 p-10 text-white shadow-xl">
        <div class="flex items-center gap-6">
            ...
            <div class="flex h-24 w-24 items-center justify-center rounded-full bg-white text-3xl font-black text-indigo-600">
            ...
            <div>
                ...
                <p class="mt-2 text-indigo-100">
                    {{ $organization->description ?? 'Organisasi Penyelenggara Event' }}
                </p>
            </div>
